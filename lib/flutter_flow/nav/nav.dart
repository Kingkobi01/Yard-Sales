      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => EditProfileWidget(
            wantsToAddItem: params.getParam(
              'wantsToAddItem',
              ParamType.bool,
            ),
          ),
        ...
        FFRoute(
          name: 'YardItems',
          path: '/yardItems',
          builder: (context, params) => const YardItemsWidget(),
        ),
        FFRoute(
          name: 'Transactions',
          path: '/transactions',
        ...
        FFRoute(
          ...
          path: '/itemDetails',
          asyncParams: {
            'selectedItem': getDoc(['item'], ItemRecord.fromSnapshot),
          },
          builder: (context, params) => ItemDetailsWidget(
            selectedItem: params.getParam(
              'selectedItem',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          ...
          asyncParams: {
            'item': getDoc(['item'], ItemRecord.fromSnapshot),
            'txn': getDoc(['Transactions'], TransactionsRecord.fromSnapshot),
          },
          builder: (context, params) => PaymentResultWidget(
            item: params.getParam(
              'item',
              ParamType.Document,
            ),
        ...
        FFRoute(
          name: 'UsersListForManager',
          path: '/usersListForManager',
          builder: (context, params) => const UsersListForManagerWidget(),
        )
