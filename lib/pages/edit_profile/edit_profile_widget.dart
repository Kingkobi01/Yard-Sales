...
class EditProfileWidget extends StatefulWidget {
  const EditProfileWidget({
    super.key,
    bool? wantsToAddItem,
  }) : wantsToAddItem = wantsToAddItem ?? false;

  final bool wantsToAddItem;
...
class _EditProfileWidgetState extends State<EditProfileWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.wantsToAddItem) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Please add Phone Number and email address before you can add an item.',
              style: TextStyle(
